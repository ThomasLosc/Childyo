 ...
 */
final class Version20240528100432 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rendez_vous ADD medecin_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rendez_vous DROP medecin_id');
    }
}
